...
SUBROUTINE  solve_spkit(A, rhs, sol,  isave)
      ...
      !     This program solve a linear system with a sparse matrix.
      !     Different methodods available:
...
!   PRINT*, ' +++++ n_syst = ', n_syst
   ...
   IF (ipar(1) <= 0  .OR.  ipar(1) > 6) THEN
      ...
      WRITE (iout,*) ''
      WRITE (iout,*) 'WARNING: SOLVE_SPKIT:'
      WRITE (iout,*) 'Method not existent  ->  Default Parameters Used'
      WRITE (iout,*) ''
   ...
   IF (PRESENT(isave)) THEN
      ...
      IF (ABS(isave) > max_save) THEN
         PRINT*, ''
         PRINT*, 'ERROR. SOLVE_SPKIT:'
         PRINT*, 'Variable isave out of range (maximum is ', max_save, ')'
         PRINT*, ''
         STOP
      ENDIF
      ...
      IF (isave >= 1) THEN
         ...
         IF (ASSOCIATED(LU_stored(isave)%i)) THEN
            ...
            IF (n_syst /= LUi_size) THEN
               PRINT*, ''
               PRINT*, 'ERROR. SOLVE_SPKIT:'
               PRINT*, 'Incoherence in the size of the linear system'
               PRINT*, 'n_syst = ', n_syst, ' LU%i_size', LUi_size
               PRINT*, ''
               STOP
            ENDIF
         ...
         ELSE
            ...
            PRINT*, ''
            PRINT*, 'ERROR. SOLVE_SPKIT:'
            PRINT*, 'The problem referred to by isave = ', isave
            PRINT*, 'has not yet been preconditioned.'
            PRINT*, 'Use a negative integer first.'
            PRINT*, ''
            STOP
   ...
   SELECT CASE (ipar(7))
      ...
      CASE DEFAULT
         ...
         PRINT*, ''
         PRINT*, 'ERROR. SOLVE_SPKIT:'
         PRINT*, 'Solver pointed to by ipar(7) not programmed yet'
         PRINT*, ''
         STOP
   ...
   SELECT CASE(ierr)
      ...
      CASE(1)
        ...
        PRINT*, ''
        PRINT*, 'ERROR. SOLVE_SPKIT:'
        PRINT*, 'Convergence not achieved in ', max_its,' iterations'
        PRINT*, ''
        !STOP
      ...
      CASE (3)
         ...
         DO
            ...
            SELECT CASE (ierr)
               ...
               CASE(1:);  WRITE (iout,*) ' SOLVE_SPKIT: zero pivot at step ', ierr 
                          WRITE (iout,*) 'STOP'
                          STOP
               CASE(-1);  WRITE (iout,*) ' SOLVE_SPKIT: input matrix is wrong ' 
                          WRITE (iout,*) 'STOP'
                          STOP
               ...
               CASE(-4);  WRITE (iout,*) ' SOLVE_SPKIT: Illegal value of lfil' 
                          WRITE (iout,*) 'STOP'
                          STOP
  
               CASE DEFAULT;  WRITE (iout,*) ' SOLVE_SPKIT: zero row encountered' 
                          WRITE (iout,*) 'STOP'
                          STOP
      ...
      CASE (4)
         ...
         DO
            ...
            SELECT CASE(ierr)
               ...
               CASE(:-5); WRITE (iout,*) ' SOLVE_SPKIT: zero row encountered'
                          WRITE (iout,*) 'STOP'
                          STOP
      ...
      CASE (6)
         ...
         DO
            ...
            SELECT CASE(ierr)
               ...
               CASE(:-3); WRITE (iout,*) ' SOLVE_SPKIT: zero row encountered'
                          WRITE (iout,*) 'STOP'
                          STOP
...
!__________________________________________________________________________________
      ...
      CASE DEFAULT
         ...
         WRITE (iout,*) 'Preconditioning methodod', method, ' not existent!'
         WRITE (iout,*) 'STOP'
         STOP
...
SUBROUTINE  cancel_mem_precond(index)
   ...
   IF (ASSOCIATED(LU_stored(index)%i)) THEN
      ...
      IF (well_done /= 0) THEN
         WRITE (iout,*) 'Deallocation of stored preconditioner failed! (LU%i)'
         WRITE (iout,*) 'STOP'
         STOP
      ENDIF
      ...
      IF (well_done /= 0) THEN
         WRITE (iout,*) 'Deallocation of stored preconditioner failed! (LU%j)'
         WRITE (iout,*) 'STOP'
         STOP
      ENDIF
      ...
      IF (well_done /= 0) THEN
         WRITE (iout,*) 'Deallocation of stored preconditioner failed! (LU%e)'
         WRITE (iout,*) 'STOP'
         STOP
      ENDIF
